...
@interface SCRushBuyCell ()

@end

@implementation SCRushBuyCell


+(instancetype)cellWithTableView:(UITableView *)tableView{
    static NSString *IDentifier = @"nomorecell";
    SCRushBuyCell *cell = [tableView dequeueReusableCellWithIdentifier:IDentifier];
    if (cell == nil) {
        cell = [[SCRushBuyCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:IDentifier];
    }
...
{
    for (int i = 0; i < 3; i++) {
        SCRushDealsModel *rush = rushData[i];
